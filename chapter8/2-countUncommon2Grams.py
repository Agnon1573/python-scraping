...
def getNgrams(input, n):
    output = {}
    output1 = getNgrams1(input, n)
    output2 = getNgrams2(input, n)
...
sortedNGrams = sorted(ngrams.items(), key = operator.itemgetter(1), reverse = True)
print(sortedNGrams)
print(getFirstSentenceContaining('executive power', content))
'''
